...
<div class="row justify-content-center">
    ...
    .button-85:after {
        ...
        <?php endif; ?>
        <div class="card">
               <div class=" shadow-lg p-3 mb-5 text-dark" role="alert" style="background: linear-gradient(0.9turn, #7bfc77, #faee0c, #e877fc);">
                <div class="row">
                    <div class="col pt-1">
                        Create License
                    </div>
    ...
    <div class="card-header p3 text-dark"style="background-image: url('https://i.postimg.cc/mkrKWBQ0/images-1.png')">
