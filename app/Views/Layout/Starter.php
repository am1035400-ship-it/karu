...
<style>
        body{
            background-image: url("https://giphy.com/gifs/abstract-gem-voronoi-l87pZAlTSahSABLNqp");
...
<body>
    ...
    <main>
        ...
        <div class="container p-6 py-4 mb-2"style="background: linear-gradient(0.9turn, #FF90BB, #8ACCD5, #FF90BB);">
