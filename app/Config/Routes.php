...
// Payment & Automated Recharge Routes (FamGateway)
$routes->match(['get', 'post'], 'recharge', 'Payment::recharge');
$routes->match(['get', 'post'], 'payment/create', 'Payment::create');
$routes->match(['get', 'post'], 'payment/status', 'Payment::status');
$routes->match(['get', 'post'], 'payment/status/(:segment)', 'Payment::status/$1');
$routes->match(['get', 'post'], 'payment/success', 'Payment::success');
$routes->match(['get', 'post'], 'api/webhook/famgateway', 'Payment::webhook');
$routes->match(['get', 'post'], 'webhook', 'Payment::webhook');
